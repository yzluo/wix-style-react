...
describe('Checkbox', () => {
  ...
  it('should warn with deprecation warning, if size === "large" passed', () => {
    ...
    expect(global.console.warn).toBeCalledWith(
      'Warning: Checkbox prop "size" with value "large" is deprecated and will be removed in next major release, please use "medium" size instead',
    );
  ...
  it('should warn with deprecation warning, if active prop passed', () => {
    ...
    expect(global.console.warn).toBeCalledWith(
      'Warning: Checkbox prop "active" is deprecated, use "checked" prop instead',
    );
    global.console.warn = cachedConsoleWarn;
  });
