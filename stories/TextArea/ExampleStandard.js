          ...
          <div className={styles.option}>
            ...
            <div className={styles.flex}>
              <Input
                ...
                onChange={e =>
                  this.setComponentState('inputArea', {
          ...
          <div className={styles.option}>
            ...
            <div className={styles.column}>
              <Input
                ...
                onChange={e =>
                  this.setComponentState('inputArea', { rows: e.target.value })
                }
              />
              <Input
                placeholder="Set min Height"
                size="small"
                type="number"
                unit="px"
              ...
              <div className={styles.option}>
                <div className={styles.flex}>
                  ...
                  <ToggleSwitch
                    ...
                    onChange={() =>
                      this.setComponentState('inputArea', {
                        hasCounter: !this.state.inputArea.hasCounter,
                      })
                    }
                  />
                </div>
              ...
              <div className={styles.option}>
                ...
                <ToggleSwitch
                  ...
                  onChange={() =>
                    this.setComponentState('inputArea', {
                      resizable: !this.state.inputArea.resizable,
                    })
                  }
                />
              </div>
