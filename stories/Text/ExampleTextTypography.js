  ...
  <div>
    ...
    <ul className={`ltr ${s.root}`}>
      ...
      <li>
        ...
        <span className={s.fonts}><Text size="tiny" weight="thin">Helvetica_45 / 12px / 15px</Text></span>
      </li>
      <li>
        <span className={s.comp}>{'<Text weight="thin" size="tiny" secondary={true} light={false}/>'}</span>
        <span className={s.fonts}><Text size="tiny" secondary weight="thin">Helvetica_45 / 12px / 15px</Text></span>
      </li>
      <li className={s.inverted}>
        <span className={s.comp}>{'<Text weight="thin" size="tiny" secondary={false} light={true}/>'}</span>
        <span className={s.fonts}><Text size="tiny" light weight="thin">Helvetica_45 / 12px / 15px</Text></span>
      </li>
      <li>
        <span className={s.comp}>{'<Text weight="thin" size="tiny" secondary={true} light={true}/>'}</span>
        <span className={s.fonts}><Text size="tiny" secondary light weight="thin">Helvetica_45 / 12px / 15px</Text></span>
      </li>
    </ul>
