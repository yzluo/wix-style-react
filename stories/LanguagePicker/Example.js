...
export default class Example extends React.Component {
  ...
  render() {
    return (
      ...
      >
        <LanguagePicker
          dataHook="story-languagePicker"
          selectedId={this.state.languageKey}
          onSelect={({ id }) => this.setState({ languageKey: id })}
        >
        ...
        <div
          id="languagePicker-output"
          style={{ paddingBottom: '22px', marginLeft: '40px' }}
        >
