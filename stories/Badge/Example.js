...
class ControlledBadgeExample extends React.Component {
  ...
  render() {
    return (
      <div>
        <div style={{ background: 'azure', width: '310px' }}>
          <Text>{`import Badge from 'wix-style-react/Badge';`}</Text>
        </div>
          ...
          <div style={{ width: '200px' }}>
            ...
            <DropdownComposite>
              ...
              <Dropdown
                ...
                options={typeOptions}
                onSelect={option => this.setState({ type: option.value })}
              />
            </DropdownComposite>

            <DropdownComposite>
              <Label>prefixIcon</Label>
              <Dropdown
                selectedId={this.state.prefixIcon}
                options={iconsOptions}
                onSelect={option => this.setState({ prefixIcon: option.value })}
              />
            </DropdownComposite>
            <DropdownComposite>
              <Label>suffixIcon</Label>
              <Dropdown
                selectedId={this.state.suffixIcon}
                options={iconsOptions}
                onSelect={option => this.setState({ suffixIcon: option.value })}
              />
            </DropdownComposite>
          </div>
          <div>
