...
const skinOptions = Object.keys(SKINS).map(value =>
  Autocomplete.createOption({ id: value, value }),
);
const sizeOptions = Object.keys(SIZES).map(value =>
  Autocomplete.createOption({ id: value, value }),
);
    ...
    return (
      <div className={style.container}>
        <div style={{ width: '300px' }}>
          ...
          <br />
          <br />
          <Heading appearance="H2">checked: </Heading>{' '}
          <ToggleSwitch
            size="small"
          ...
          <br />
          <br />
          <Heading appearance="H2">disabled: </Heading>{' '}
          <ToggleSwitch
            size="small"
          ...
          <br />
          <br />
          <Heading appearance="H2">tabIndex: </Heading>{' '}
          <Text bold>Tab Index</Text>
          <br />
          <br />
          <Heading appearance="H2">onChange: </Heading>{' '}
          <Text bold>
            Callback function when User changes the value of the component
          </Text>
          <br />
          <br />
          <Heading appearance="H2">id: </Heading>{' '}
          <Text bold>The ID attribute to put on the toggle</Text>
          <br />
          <br />
        </div>
        <div>
